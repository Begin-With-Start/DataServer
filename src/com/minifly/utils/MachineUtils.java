...
public class MachineUtils {
    ...
    public static MachineUtils SYSTEMINFO;  
      
    public static MachineUtils getInstance(){  
        if(SYSTEMINFO == null){  
            SYSTEMINFO = new MachineUtils();  
        }  
        return SYSTEMINFO;  
    }  
      
      
    public static MachineUtils getInstance(HttpServletRequest request){  
        if(SYSTEMINFO == null){  
            SYSTEMINFO = new MachineUtils(request);  
        }  
        else {  
    ...
    private MachineUtils(HttpServletRequest request) {  
        super();  
        init();  
        /** 
         * 额外信息 
    ...
    private void ipMac() throws Exception{  
        ...
        MachineUtils.this.os_ip = sIP;
        MachineUtils.this.os_mac = sMAC;
    }  
